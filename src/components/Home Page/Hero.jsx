    ...
    return (
        <section className="text-light bg-black text-center py-5">
            <div className="container" style={{ fontFamily: "ClashDisplayVariable" }}>
                ...
                <button id='hero-button' className="hero-button btn btn-lg btn-primary mt-4" style={{ borderRadius: "15px", backgroundColor: "#A883C4" }}><img src={DownRightArrow} style={{ height: "2.5rem", marginRight: "5px" }} />RENT NOTES</button>                
            </div>
            <div className="mt-5">
