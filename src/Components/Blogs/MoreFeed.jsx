		...
		<div className="flex flex-col gap-6">
			...
			<div className="min-w-full flex flex-col lg:flex-row gap-5 hover:*:scale-110 transition-all *:duration-200">
				{feeds.map((feed, index) => (
					<Card
						key={index}
						className="!max-w-md lg:!max-w-lg mx-auto text-center justify-between !bg-zinc-200 !text-slate-800 !h-80 lg:!h-96 xl:!h-72 flex flex-col gap-3 hover:-translate-y-5"
					>
