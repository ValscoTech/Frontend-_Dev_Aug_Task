...
const AppPromotion = () => {
	return (
		<section className="flex w-full my-32 md:w-11/12 lg:w-5/6 xl:w-3/4 mx-auto items-center justify-center bg-zinc-100 shadow-lg rounded-3xl p-10  gap-10">
			...
			<img
				...
				alt="Phone App"
				className="w-16 sm:w-20 py-5 md:w-28 lg:w-36 xl:w-48"
			/>
		</section>
	);
};
